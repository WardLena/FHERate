...
import type { FhevmWindowType, FhevmRelayerSDKType } from "./types";

export class RelayerSDKLoader {
  private _trace?: (message?: any, ...optionalParams: any[]) => void;

  constructor(options: { trace?: (message?: any, ...optionalParams: any[]) => void }) {
